      ...
      <div class="card-body">
        <form v-on:submit.prevent="agregarRegistro">
            <div class="form-group">
              ...
              <input type="text"
                class="form-control" required name="nombre" v-model="empleado.nombre" id="" aria-describedby="helpId" placeholder="Nombre">
...
export default {
  ...
  methods:{
    agregarRegistro(){
      ...
      fetch('https://localhost/empleados/?insertar=1',{
        method:"POST",
